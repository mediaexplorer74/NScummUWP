        ...
        public App()
        {
            try
            {
                ...
                catch (Exception ex)
                {
                    ...
                    Debug.WriteLine("[ex] (App.xaml...) : " + ex.Message);
                }
            }
            catch (Exception ex2)
            {
                Debug.WriteLine("[ex2] (App.xaml...) : " + ex2.Message);
            }
        ...
        private void OnUnhandledException(object sender, Windows.UI.Xaml.UnhandledExceptionEventArgs e)
        {
            if (e != null)
            {
                    ...
                    && exception.ToString().ToUpper().Contains("INNERACTIVE"))
                {
                    ...
                    && exception.ToString().ToUpper().Contains("SOMA"))
                {
                    Debug.WriteLine("Handled Smaato null reference exception {0}", exception);
                    e.Handled = true;
                    return;
                }
                else if ((exception is System.IO.IOException || exception 
                    is NullReferenceException) && exception.ToString().ToUpper().Contains("GOOGLE"))
                {
                    ...
                    && exception.ToString().ToUpper().Contains("MOBFOX"))
                {
                    ...
                    || exception is XamlParseException || exception is TypeLoadException)
