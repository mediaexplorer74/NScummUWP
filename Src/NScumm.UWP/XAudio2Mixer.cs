    ...
    class XAudio2Mixer : IAudioOutput
    {
        class XAudioBuffer : IDisposable
        {
            ...
            public bool FillWith(IAudioSampleProvider audioSampleProvider)
            {
                ...
                {
                    Debug.WriteLine("[ex] XAudio2Mixer (FillWith) : " + ex.Message);
                    return false;
                }
                return true;
            }
        ...
        public void SetSampleProvider(IAudioSampleProvider audioSampleProvider)
        {
            ...
            _audioThread = Task.Factory.StartNew(OnAudioThread, CancellationToken.None, 
        ...
        private void OnAudioThread()
        {
            ...
            {
                Debug.WriteLine("[ex] XAudio2Mixer (OnAudioThread) : " + ex.Message);
            }
        }
        ...
        private bool FillBuffer(int index)
        {
            ...
            {
                Debug.WriteLine("[ex] XAudio2Mixer (FillBuffer) : " + ex.Message);
            }
            return state;
        }
