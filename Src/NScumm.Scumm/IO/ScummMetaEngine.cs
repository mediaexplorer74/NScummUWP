...
namespace NScumm.Scumm.IO
{
    public class ScummMetaEngine : IMetaEngine
    {
        ...
        public IEngine Create(GameSettings settings, IGraphicsManager gfxManager, 
            IInputManager inputManager, IAudioOutput output, ISaveFileManager saveFileManager, 
